...
\begin{itemize}
    ...
    \end{labeling}
    \footnotetext[1]{Actually the correct term would be `pass through', but since we used the wrong one throughout the lab days, we are going to stick to `throughput'.}
\end{itemize}
